...
NP_S1 = "(NP <: /^NN|DT|PRP|CD/)"

#Two item simple noun phrase, e.g. a magnet, the bear, my back tends to be on the object position

NP_S2 = "(NP<1/DT|PRP$/<2/^NN|DT|PRP|CD/!<3__)"

#Two item simple noun phrase, e.g. a magnet men, the pet store

NP_S3 = "(NP<1/DT|PRP$/<2/^NN|DT|PRP|CD/<3/^NN|DT|PRP|CD/!<4__)"

#Simple NP with a JJ
## TODO: Optional determiner

NP_SJJ = "(NP<1/DT|PRP$/<2/^JJ/<3/^NN|DT|PRP|CD/!<4__)"

#Simple NP: the best

NP_JJS = "(NP<1/DT|PRP$/<2/^JJ/!<3__)"
...
VP_NP_jj = f"(VP<1/^VB/<2{NP_SJJ}!<3__)"

VP_NP_jjs = f"(VP<1/^VB/<2{NP_JJS}!<3__)"
...
ADJP_1 = f"'{ADJP_S1}!>__'"
ADJP_1p = f"'(ADJP<1/^JJ/<2{P}!<3__)!>__'"
...
# NP det Noun: a cat
NP_2_det = f"'{NP_S2}!>__'"
NP_2_det_p = f"'(NP<1/DT|PRP$/<2/^NN|DT|PRP|CD/<3{P}!<4__)!>__'"
# NP adjp noun: blue cat
NP_2_ADJP = "'(NP<1/^JJ/<2/^NN|DT|PRP|CD/!<3__)!>__'"
NP_2_ADJP_p = f"'(NP<1/^JJ/<2/^NN|DT|PRP|CD/<3{P}!<4__)!>__'"
#Subjectless VP: do this


##Triple item
# det JJ N: a blue cat
NP_3_ADJP = "'(NP<1/DT|PRP$/<2/^JJ/<3/^NN|DT|PRP|CD/!<4__)!>__'"
NP_3_ADJP_p = f"'(NP<1/DT|PRP$/<2/^JJ/<3/^NN|DT|PRP|CD/<4{P}!<5__)!>__'"
...
SV_S_a = f"'(S[<1{NP_SJJ}|<1{NP_JJS}]<2{VP_S}<3{P})!>__'"
...
SVO_Ojj = f"'(S[<1{NP_SJJ}|<1{NP_JJS}]<2{VP_SO}<3{P})!>__'"

#Simple sentence, transitive, w/ adjective mod on S and O: the cute girl answers the pink phone

SVO_jj = f"'(S[<1{NP_SJJ}|<1{NP_JJS}][<2{VP_NP_jj}|<2{VP_NP_jjs}]<3{P})!>__'"
